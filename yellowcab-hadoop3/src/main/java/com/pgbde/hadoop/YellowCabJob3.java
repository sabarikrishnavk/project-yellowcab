...
public class YellowCabJob3 extends Configured implements Tool {
...
//		args = new String[] { "input/input.txt", "output/test/"};
	...
	public static void main(String[] args) throws Exception {
		...
		int returnStatus = ToolRunner.run(new Configuration(), new YellowCabJob3(),
			args);
	...
	public int run(String[] args) throws IOException {
		...
		try {
			...
			job.setJarByClass(YellowCabJob3.class);
