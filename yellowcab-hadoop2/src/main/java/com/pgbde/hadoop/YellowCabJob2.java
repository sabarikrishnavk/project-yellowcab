...
public class YellowCabJob2 extends Configured implements Tool {
...
//		args = new String[] { "input/input.txt", "output/test/"};
	...
	public static void main(String[] args) throws Exception {
		...
		int returnStatus = ToolRunner.run(new Configuration(), new YellowCabJob2(),
			args);
	...
	public int run(String[] args) throws IOException {
		...
		try {
			...
			job.setJarByClass(YellowCabJob2.class);
